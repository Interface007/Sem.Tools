...
////    {
////        public static string ToMarkDown(this XNode e, string currentNameSpace)
////        {

////            var templates = new Dictionary<string, string[]>
////            {
////                { "doc      ".Trim(), new [] {"# {0} ##\n\n{1}\n\n"}},
////                { "type     ".Trim(), new [] {"## Type: {0} (#{0})\n\n{1}\n\n---\n"}},
////                { "field    ".Trim(), new [] {""}},
////                { "property ".Trim(), new [] {"### {0} (#{0})\n\n{1}\n\n---\n"}},
////                { "method   ".Trim(), new [] {"### Method: {0} (#{0})\n\n{1}\n\n---\n"}},
////                { "event    ".Trim(), new [] {"### {0} (#{0})\n\n{1}\n\n---\n"}},
////                { "summary  ".Trim(), new [] {"{0}\n\n"}},
////                { "remarks  ".Trim(), new [] {"\n\n>{0}\n\n"}},
////                { "example  ".Trim(), new [] {"_C# code_\n\n```c#\n{0}\n```\n\n"}},
////                { "seePage  ".Trim(), new [] {"[{1}|{0}]]"}},
////                { "seeAnchor".Trim(), new [] {"[{1}]({0}#{2})"}},
...
////                var markDown = values.Length switch
////                {
...
////        private static string[] GetLink(Func<string, XElement, string[]> d, XElement x)
////        {
////            var parts = d("cref", x);
////            var part = parts[0];
////            string className;
...
////                    return parts;
////                case 'M':
////                    var par = part.IndexOf('(');
////                    className = part.Substring(0, part.Substring(0, par).LastIndexOf('.'));
////                    return parts;
