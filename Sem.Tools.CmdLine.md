...
## Type: Sem.Tools.CmdLine.MenuItem
 ...
 Menu item for a command line program. An array of menu items can be displayed using the extension method [Menu.Show(MenuItem[])](Sem.Tools.CmdLine.md#Menu.Show(MenuItem[])). 
...
### Method: MenuItem.#ctor(String, Func\<Task>, String)
 ...
 Initializes a new instance of the [Sem.Tools.CmdLine.MenuItem](Sem.Tools.CmdLine.md#Sem.Tools.CmdLine.MenuItem) class. 
...
### Method: MenuItem.Print(Linq.Expressions.Expression\<Func\<IAsyncEnumerable\<String>>>, String)
 ...
 Creates a [Sem.Tools.CmdLine.MenuItem](Sem.Tools.CmdLine.md#Sem.Tools.CmdLine.MenuItem) from an expression - is meant to be used with a ```System.Linq.Expressions.MethodCallExpression```. 
